...
class Account extends TagoIOModule_1.default {
     ...
     */
    static tokenCreate(tokenParams, region) {
        const params = {
            path: "/account/profile/token",
            method: "POST",
            body: tokenParams,
        };
        const result = TagoIOModule_1.default.doRequestAnonymous(params, region);
        return result;
    }
    /**
     ...
     * @param region TagoIO Region Server [default usa-1]
     */
    static login(credentials, region) {
        const params = {
            path: "/account/login",
            method: "POST",
            body: credentials,
     ...
     * @param region TagoIO Region Server [default usa-1]
     */
    static passwordRecover(email, region) {
        const params = {
     ...
     * @param region TagoIO Region Server [default usa-1]
     */
    static create(createParams, region) {
        const params = {
            path: `/account`,
            method: "POST",
            body: createParams,
     ...
     * @param region TagoIO Region Server [default usa-1]
     */
    static resendConfirmation(email, region) {
        const params = {
     ...
     * @param region TagoIO Region Server [default usa-1]
     */
    static confirmAccount(token, region) {
        const params = {
